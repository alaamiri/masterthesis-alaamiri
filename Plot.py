...
def accuracy_plot(accuracy_list, nb_net, nb_layers):
    ...
    plt.savefig(f"plot/acc_plot_{nb_net}_{nb_layers}.png")
    plt.show()

def loss_plot(loss_list, nb_net, nb_layers):
    print(loss_list)
    ...
    plt.savefig(f"plot/loss_plot_{nb_net}_{nb_layers}.png")
    plt.show()